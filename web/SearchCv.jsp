<%-- 
    Document   : SearchCv
    Created on : 17 Μαϊ 2017, 3:47:47 μμ
    Author     : Maraki
--%>
    ...
    <body>
        ...
        <nav>
            <ul>
                ...
                <article>
            <h style="font-size:120%; text-shadow: 1px 1px #006666;"><b>Βιογραφικά Αλφαβητικά:</b></h>
            <br><br>
            <%
                String sql = "select uname, name, surname from user order by surname, name";
                ResultSet rs = SMT.executeQuery(sql);

                found = rs.first();
                if (!found) {
                    out.println("Δεν έχουν καταχωρηθεί βιογραφικά από φοιτητές.");
            %>
            <br>
            <%
            } else {
