<%-- 
    Document   : inInterSubmit
    Created on : 3 Μαϊ 2017, 8:57:10 μμ
    Author     : Maraki
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String sql;
            String sql1;
            String select[] = request.getParameterValues("Interest");
            ...
            sql = "delete from stud_int where Uname='" + U + "'";
            SMT.executeUpdate(sql);

            if (select != null && select.length != 0) {
                for (int i = 0; i < select.length; i++) {
                    sql1 = "insert into stud_int(Uname, Interest) values ('" + U + "', '" + select[i] + "')";
                    SMT.executeUpdate(sql1);
                }

            }
            out.println("Τα επιστημονικά ενδιαφέροντά σας ενημερώθηκαν με επιτυχία!");
        %>
        <P></P>
