<%-- 
    Document   : SearchCv_Inst
    Created on : 17 Μαϊ 2017, 4:28:16 μμ
    Author     : Maraki
--%>
...
<html>
    ...
    <body>
        ...
        <article>
            <h style="font-size:120%; text-shadow: 1px 1px #006666;"><b>Βιογραφικά φοιτητών που ανήκουν στο <%=Insti%>:</b></h>
            <br><br>
            <%
                sql = "select uname, name, surname from user where INSTITUTION='" + Insti + "'";
