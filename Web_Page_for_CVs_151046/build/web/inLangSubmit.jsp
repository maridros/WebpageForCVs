<%-- 
    Document   : inLangSubmit
    Created on : 11 Μαϊ 2017, 6:52:34 μμ
    Author     : Maraki
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            sql = "delete from stud_lang where Uname='" + U + "'";
            SMT.executeUpdate(sql);

            if (select != null && select.length != 0) {
                for (int i = 0; i < select.length; i++) {
                    l = request.getParameter(select[i]);
                    sql1 = "insert into stud_lang(Uname, Language, Level) values ('" + U + "', '" + select[i] + "', '" + l + "')";
                    SMT.executeUpdate(sql1);
                }

            }
            out.println("Οι ξένες γλώσσες που γνωρίζετε ενημερώθηκαν με επιτυχία!");
        %>
        <P></P>
