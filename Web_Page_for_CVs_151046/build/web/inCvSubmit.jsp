<%-- 
    Document   : inCvSubmit
    Created on : 16 Μαϊ 2017, 5:59:22 μμ
    Author     : Maraki
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            String cv = request.getParameter("myCv");
            ...
            String sql = "update user set cv='" + cv + "' where Uname='" + U + "'";

            SMT.executeUpdate(sql);
            out.println("Το βιογραφικό σας προστέθηκε με επιτυχία!");
        %>
        <P></P>
