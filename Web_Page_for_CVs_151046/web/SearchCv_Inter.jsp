<%-- 
    Document   : SearchCv_Inter
    Created on : 17 Μαϊ 2017, 4:27:56 μμ
    Author     : Maraki
--%>
...
<!DOCTYPE html>
<%
    String Intere = request.getParameter("Interest");
    boolean found;
    String Inst;
    int InstNum;
    String Inter;
...
<html>
    ...
    <body>
        ...
        <article>
            <h style="font-size:120%; text-shadow: 1px 1px #006666;"><b>Βιογραφικά φοιτητών με επιστημονικό ενδιαφέρον <%=Intere%>:</b></h>
            <br><br>
            <%
                sql = "select user.uname, surname, name from user, stud_int where interest='" + Intere + "' and stud_int.UNAME=user.uname";
